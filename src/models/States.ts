...
export const SchleswigHolzstein = mongoose.model("schleswig-holzstein-question", stateSchema);
export const Thuringen = mongoose.model("thuringen-question", stateSchema);
...
export const NordrheinWestfallen = mongoose.model("nordrhein-westfallen-question", stateSchema);
export const RheinlandPfalz = mongoose.model("rheinlandPfalz-question", stateSchema);
export const BadenWurttemberg = mongoose.model("badenwurttemberg-question", stateSchema);
